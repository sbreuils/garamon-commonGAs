...
/// \brief Class to define a multivector and its basic operators in the Geometric algebra of c4ga.


// Anti-doublon
#ifndef C4GA_MULTI_VECTOR_HPP__
#define C4GA_MULTI_VECTOR_HPP__
#pragma once
...
#include "c4ga/Geometric.hpp"

#include "c4ga/OuterExplicit.hpp"
#include "c4ga/InnerExplicit.hpp"
#include "c4ga/GeometricExplicit.hpp"
...
*/
        ...
        Mvec e0() const {return this->extractOneComponent(1,6, 0);}
        Mvec e1() const {return this->extractOneComponent(1,6, 1);}
        Mvec e2() const {return this->extractOneComponent(1,6, 2);}
        Mvec e3() const {return this->extractOneComponent(1,6, 3);}
        Mvec e4() const {return this->extractOneComponent(1,6, 4);}
        Mvec ei() const {return this->extractOneComponent(1,6, 5);}
        Mvec e01() const {return this->extractOneComponent(2,15, 0);}
        Mvec e02() const {return this->extractOneComponent(2,15, 1);}
        Mvec e03() const {return this->extractOneComponent(2,15, 2);}
        Mvec e04() const {return this->extractOneComponent(2,15, 3);}
        Mvec e0i() const {return this->extractOneComponent(2,15, 4);}
        Mvec e12() const {return this->extractOneComponent(2,15, 5);}
        Mvec e13() const {return this->extractOneComponent(2,15, 6);}
        Mvec e14() const {return this->extractOneComponent(2,15, 7);}
        Mvec e1i() const {return this->extractOneComponent(2,15, 8);}
        Mvec e23() const {return this->extractOneComponent(2,15, 9);}
        Mvec e24() const {return this->extractOneComponent(2,15, 10);}
        Mvec e2i() const {return this->extractOneComponent(2,15, 11);}
        Mvec e34() const {return this->extractOneComponent(2,15, 12);}
        Mvec e3i() const {return this->extractOneComponent(2,15, 13);}
        Mvec e4i() const {return this->extractOneComponent(2,15, 14);}
        Mvec e012() const {return this->extractOneComponent(3,20, 0);}
        Mvec e013() const {return this->extractOneComponent(3,20, 1);}
        Mvec e014() const {return this->extractOneComponent(3,20, 2);}
        Mvec e01i() const {return this->extractOneComponent(3,20, 3);}
        Mvec e023() const {return this->extractOneComponent(3,20, 4);}
        Mvec e024() const {return this->extractOneComponent(3,20, 5);}
        Mvec e02i() const {return this->extractOneComponent(3,20, 6);}
        Mvec e034() const {return this->extractOneComponent(3,20, 7);}
        Mvec e03i() const {return this->extractOneComponent(3,20, 8);}
        Mvec e04i() const {return this->extractOneComponent(3,20, 9);}
        Mvec e123() const {return this->extractOneComponent(3,20, 10);}
        Mvec e124() const {return this->extractOneComponent(3,20, 11);}
        Mvec e12i() const {return this->extractOneComponent(3,20, 12);}
        Mvec e134() const {return this->extractOneComponent(3,20, 13);}
        Mvec e13i() const {return this->extractOneComponent(3,20, 14);}
        Mvec e14i() const {return this->extractOneComponent(3,20, 15);}
        Mvec e234() const {return this->extractOneComponent(3,20, 16);}
        Mvec e23i() const {return this->extractOneComponent(3,20, 17);}
        Mvec e24i() const {return this->extractOneComponent(3,20, 18);}
        Mvec e34i() const {return this->extractOneComponent(3,20, 19);}
        Mvec e0123() const {return this->extractOneComponent(4,15, 0);}
        Mvec e0124() const {return this->extractOneComponent(4,15, 1);}
        Mvec e012i() const {return this->extractOneComponent(4,15, 2);}
        Mvec e0134() const {return this->extractOneComponent(4,15, 3);}
        Mvec e013i() const {return this->extractOneComponent(4,15, 4);}
        Mvec e014i() const {return this->extractOneComponent(4,15, 5);}
        Mvec e0234() const {return this->extractOneComponent(4,15, 6);}
        Mvec e023i() const {return this->extractOneComponent(4,15, 7);}
        Mvec e024i() const {return this->extractOneComponent(4,15, 8);}
        Mvec e034i() const {return this->extractOneComponent(4,15, 9);}
        Mvec e1234() const {return this->extractOneComponent(4,15, 10);}
        Mvec e123i() const {return this->extractOneComponent(4,15, 11);}
        Mvec e124i() const {return this->extractOneComponent(4,15, 12);}
        Mvec e134i() const {return this->extractOneComponent(4,15, 13);}
        Mvec e234i() const {return this->extractOneComponent(4,15, 14);}
        Mvec e01234() const {return this->extractOneComponent(5,6, 0);}
        Mvec e0123i() const {return this->extractOneComponent(5,6, 1);}
        Mvec e0124i() const {return this->extractOneComponent(5,6, 2);}
        Mvec e0134i() const {return this->extractOneComponent(5,6, 3);}
        Mvec e0234i() const {return this->extractOneComponent(5,6, 4);}
        Mvec e1234i() const {return this->extractOneComponent(5,6, 5);}
        Mvec e01234i() const {return this->extractOneComponent(6,1, 0);}
    ...
    Mvec<T> Iinv() {
        Mvec<T> mvec;
        mvec[63] = pseudoScalarInverse; // we do not return just a scalar of type T because the grade should be dimension and not 0.
        return mvec;
    }
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 03.
    template<typename T>
    static Mvec<T> e03(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 04.
    template<typename T>
    static Mvec<T> e04(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 3i.
    template<typename T>
    static Mvec<T> e3i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 4i.
    template<typename T>
    static Mvec<T> e4i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 023.
    template<typename T>
    static Mvec<T> e023(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 034.
    template<typename T>
    static Mvec<T> e034(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 03i.
    template<typename T>
    static Mvec<T> e03i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 04i.
    template<typename T>
    static Mvec<T> e04i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 13i.
    template<typename T>
    static Mvec<T> e13i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 14i.
    template<typename T>
    static Mvec<T> e14i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 23i.
    template<typename T>
    static Mvec<T> e23i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 24i.
    template<typename T>
    static Mvec<T> e24i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 34i.
    template<typename T>
    static Mvec<T> e34i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 013i.
    template<typename T>
    static Mvec<T> e013i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 014i.
    template<typename T>
    static Mvec<T> e014i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 0234.
    template<typename T>
    static Mvec<T> e0234(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 023i.
    template<typename T>
    static Mvec<T> e023i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 024i.
    template<typename T>
    static Mvec<T> e024i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 034i.
    template<typename T>
    static Mvec<T> e034i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 123i.
    template<typename T>
    static Mvec<T> e123i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 124i.
    template<typename T>
    static Mvec<T> e124i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 134i.
    template<typename T>
    static Mvec<T> e134i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 234i.
    template<typename T>
    static Mvec<T> e234i(){
        Mvec<T> res;
    ...
    /// \brief return a multivector that contains only the unit basis k-vector 0123i.
    template<typename T>
    static Mvec<T> e0123i(){
        Mvec<T> res;
        return res.componentToOne(5, 1);
    }

    /// \brief return a multivector that contains only the unit basis k-vector 0124i.
    template<typename T>
    static Mvec<T> e0124i(){
        Mvec<T> res;
        return res.componentToOne(5, 2);
    }

    /// \brief return a multivector that contains only the unit basis k-vector 0134i.
    template<typename T>
    static Mvec<T> e0134i(){
        Mvec<T> res;
        return res.componentToOne(5, 3);
    }

    /// \brief return a multivector that contains only the unit basis k-vector 0234i.
    template<typename T>
    static Mvec<T> e0234i(){
        Mvec<T> res;
        return res.componentToOne(5, 4);
    }

    /// \brief return a multivector that contains only the unit basis k-vector 1234i.
    template<typename T>
    static Mvec<T> e1234i(){
        Mvec<T> res;
        return res.componentToOne(5, 5);
    }

    /// \brief return a multivector that contains only the unit basis k-vector 01234i.
    template<typename T>
    static Mvec<T> e01234i(){
        Mvec<T> res;
