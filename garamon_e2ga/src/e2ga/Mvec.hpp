...
/// \brief Class to define a multivector and its basic operators in the Geometric algebra of e2ga.


// Anti-doublon
#ifndef E2GA_MULTI_VECTOR_HPP__
#define E2GA_MULTI_VECTOR_HPP__
#pragma once
...
#include "e2ga/Outer.hpp"
#include "e2ga/Inner.hpp"
#include "e2ga/Geometric.hpp"

#include "e2ga/OuterExplicit.hpp"
#include "e2ga/InnerExplicit.hpp"
#include "e2ga/GeometricExplicit.hpp"
...
*/
        ...
        Mvec e1() const {return this->extractOneComponent(1,2, 0);}
        Mvec e2() const {return this->extractOneComponent(1,2, 1);}
        Mvec e12() const {return this->extractOneComponent(2,1, 0);}
    ...
    Mvec<T> Iinv() {
        Mvec<T> mvec;
        mvec[3] = pseudoScalarInverse; // we do not return just a scalar of type T because the grade should be dimension and not 0.
        return mvec;
    }
