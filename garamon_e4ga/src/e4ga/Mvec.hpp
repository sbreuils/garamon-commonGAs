...
/// \brief Class to define a multivector and its basic operators in the Geometric algebra of e4ga.


// Anti-doublon
#ifndef E4GA_MULTI_VECTOR_HPP__
#define E4GA_MULTI_VECTOR_HPP__
#pragma once
...
#include "e4ga/Outer.hpp"
#include "e4ga/Inner.hpp"
#include "e4ga/Geometric.hpp"

#include "e4ga/OuterExplicit.hpp"
#include "e4ga/InnerExplicit.hpp"
#include "e4ga/GeometricExplicit.hpp"
...
*/
        ...
        Mvec e2() const {return this->extractOneComponent(1,4, 1);}
        Mvec e3() const {return this->extractOneComponent(1,4, 2);}
        Mvec e4() const {return this->extractOneComponent(1,4, 3);}
        Mvec e12() const {return this->extractOneComponent(2,6, 0);}
        Mvec e13() const {return this->extractOneComponent(2,6, 1);}
        Mvec e14() const {return this->extractOneComponent(2,6, 2);}
        Mvec e23() const {return this->extractOneComponent(2,6, 3);}
        Mvec e24() const {return this->extractOneComponent(2,6, 4);}
        Mvec e34() const {return this->extractOneComponent(2,6, 5);}
        Mvec e123() const {return this->extractOneComponent(3,4, 0);}
        Mvec e124() const {return this->extractOneComponent(3,4, 1);}
        Mvec e134() const {return this->extractOneComponent(3,4, 2);}
        Mvec e234() const {return this->extractOneComponent(3,4, 3);}
        Mvec e1234() const {return this->extractOneComponent(4,1, 0);}
