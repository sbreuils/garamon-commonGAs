...
/// \brief Class to define a multivector and its basic operators in the Geometric algebra of c3ga.


// Anti-doublon
#ifndef C3GA_MULTI_VECTOR_HPP__
#define C3GA_MULTI_VECTOR_HPP__
#pragma once
...
#include "c3ga/Geometric.hpp"

#include "c3ga/OuterExplicit.hpp"
#include "c3ga/InnerExplicit.hpp"
#include "c3ga/GeometricExplicit.hpp"
...
*/
        ...
        Mvec e0() const {return this->extractOneComponent(1,5, 0);}
        Mvec e1() const {return this->extractOneComponent(1,5, 1);}
        Mvec e2() const {return this->extractOneComponent(1,5, 2);}
        Mvec e3() const {return this->extractOneComponent(1,5, 3);}
        Mvec ei() const {return this->extractOneComponent(1,5, 4);}
        Mvec e01() const {return this->extractOneComponent(2,10, 0);}
        Mvec e02() const {return this->extractOneComponent(2,10, 1);}
        Mvec e03() const {return this->extractOneComponent(2,10, 2);}
        Mvec e0i() const {return this->extractOneComponent(2,10, 3);}
        Mvec e12() const {return this->extractOneComponent(2,10, 4);}
        Mvec e13() const {return this->extractOneComponent(2,10, 5);}
        Mvec e1i() const {return this->extractOneComponent(2,10, 6);}
        Mvec e23() const {return this->extractOneComponent(2,10, 7);}
        Mvec e2i() const {return this->extractOneComponent(2,10, 8);}
        Mvec e3i() const {return this->extractOneComponent(2,10, 9);}
        Mvec e012() const {return this->extractOneComponent(3,10, 0);}
        Mvec e013() const {return this->extractOneComponent(3,10, 1);}
        Mvec e01i() const {return this->extractOneComponent(3,10, 2);}
        Mvec e023() const {return this->extractOneComponent(3,10, 3);}
        Mvec e02i() const {return this->extractOneComponent(3,10, 4);}
        Mvec e03i() const {return this->extractOneComponent(3,10, 5);}
        Mvec e123() const {return this->extractOneComponent(3,10, 6);}
        Mvec e12i() const {return this->extractOneComponent(3,10, 7);}
        Mvec e13i() const {return this->extractOneComponent(3,10, 8);}
        Mvec e23i() const {return this->extractOneComponent(3,10, 9);}
        Mvec e0123() const {return this->extractOneComponent(4,5, 0);}
        Mvec e012i() const {return this->extractOneComponent(4,5, 1);}
        Mvec e013i() const {return this->extractOneComponent(4,5, 2);}
        Mvec e023i() const {return this->extractOneComponent(4,5, 3);}
        Mvec e123i() const {return this->extractOneComponent(4,5, 4);}
        Mvec e0123i() const {return this->extractOneComponent(5,1, 0);}
    ...
    Mvec<T> Iinv() {
        Mvec<T> mvec;
        mvec[31] = pseudoScalarInverse; // we do not return just a scalar of type T because the grade should be dimension and not 0.
        return mvec;
    }
