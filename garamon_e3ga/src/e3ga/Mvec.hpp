...
/// \brief Class to define a multivector and its basic operators in the Geometric algebra of e3ga.


// Anti-doublon
#ifndef E3GA_MULTI_VECTOR_HPP__
#define E3GA_MULTI_VECTOR_HPP__
#pragma once
...
#include "e3ga/Geometric.hpp"

#include "e3ga/OuterExplicit.hpp"
#include "e3ga/InnerExplicit.hpp"
#include "e3ga/GeometricExplicit.hpp"
...
*/
        ...
        Mvec e1() const {return this->extractOneComponent(1,3, 0);}
        Mvec e2() const {return this->extractOneComponent(1,3, 1);}
        Mvec e3() const {return this->extractOneComponent(1,3, 2);}
        Mvec e12() const {return this->extractOneComponent(2,3, 0);}
        Mvec e13() const {return this->extractOneComponent(2,3, 1);}
        Mvec e23() const {return this->extractOneComponent(2,3, 2);}
        Mvec e123() const {return this->extractOneComponent(3,1, 0);}
